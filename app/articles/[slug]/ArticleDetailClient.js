...
import { loadArticlesData, getArticleBySlug, getArticleImagePath } from '@/lib/loadArticlesData';
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        const articleData = getArticleBySlug(articles, slug);
